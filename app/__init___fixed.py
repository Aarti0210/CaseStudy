...
def _register_blueprints(app):
    ...
    from .routes import (
        auth_bp, case_bp, case_activity_bp, document_bp,
        hearing_bp, payment_bp, audit_bp, notification_bp
    )
    ...
    app.register_blueprint(case_bp, url_prefix="/api/v1/case")
    app.register_blueprint(case_activity_bp, url_prefix="/api/v1/activity")
    app.register_blueprint(hearing_bp, url_prefix="/api/v1/hearing")
    ...
    app.register_blueprint(document_bp, url_prefix="/api/v1/document")
...
def _create_tables_if_needed(app):
    """Create database tables if explicitly requested."""
    # Only create tables if CREATE_ALL_ON_START is set to "1"
